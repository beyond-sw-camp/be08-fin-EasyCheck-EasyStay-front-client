      ...
      <div class="container custom-login-container my-auto position-relative">
        <div class="row">
          <div class="col-12">
            <div
              class="bg-image"
              :style="{ backgroundImage: 'url(' + easystayImage + ')' }"
              style="
            ...
            >
              <div
                class="py-3 mb-3 text-center"
                style="background-color: rgba(255, 255, 255, 0.3); width: 100%"
              >
                <h3 class="text-black font-weight-bolder mb-0 mt-4 mb-2">
                  테마파크 예약 내역
                </h3>
                <h6 class="text-black-50 mt-3">
                  고객님의 EASY STAY 테마파크 예약 현황을 확인하실 수 있습니다.
                </h6>
                    ...
                    >
                      <div class="d-flex align-items-center me-3">
                        ...
                        >
                          ...
                          <option
                            v-for="branch in noticeStore.accommodations"
                            :key="branch.id"
                            :value="branch.name"
                          >
                            {{ branch.name }}
          ...
          <div class="row justify-content-center text-black fs-6 mb-4">
            <div class="text-center mt-3">
              <h5 class="custom-font">
                EASY STAY's membership offers special value.
              </h5>
          ...
          <div class="col-12 mt-4">
            ...
            <div
              style="border-top: 1px solid #000; width: 100%; margin: 10px auto"
            ></div>
